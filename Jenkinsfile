pipeline {
  environment {
    calculator_image = 'mblyweer/calculator'
    
    sum_image = 'mblyweer/sum'
    sub_image = 'mblyweer/sub'
    mul_image = 'mblyweer/mul'
    div_image = 'mblyweer/div'
    sum_link = 'https://github.com/YacineSteeve/Sum_service.git'
    sub_link = 'https://github.com/YacineSteeve/Sub_service.git'
    mul_link = 'https://github.com/YacineSteeve/Mul_service.git'
    div_link = 'https://github.com/YacineSteeve/Div_service.git'
    calculator_link = 'https://github.com/YacineSteeve/Calculator_service.git'
    dockerImage = ""
    registryCredential = 'repo_login'
  
    //provide this line with one of your worker floating IP
    build_arg="--build-arg HIS_IP='192.168.37.8' ."
  }
